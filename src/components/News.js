...
const News = (props) => {
    ...
    useEffect(() => {
        ...
        document.title = `NewsWeb - ${capitalize(props.category)}`        
        updateNews()
    ...
    const fetchMoreData = async () => {
        ...
        return (
            <>
                <h1 className="text-center" style={{ margin: '30px',marginTop:'90px' }}>NewsWeb - Top {capitalize(props.category)} Headlines</h1>
                {loading && <Spinner/>}
                <InfiniteScroll
